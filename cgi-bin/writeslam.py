...
conn.execute('insert into slam values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)',(fname,lname,dob,email,phno,gender,category,color,food,sport,hero,heroine,place,bestfrnds,view))
...
<body>
 ...
 <h1>slam written successfully</h1>
